...
- [ ] Table renders as plain text with visible `|` column separators (Vim has no built-in table rendering — `vim-table-mode`-style auto-alignment is a full-feature-Neovim thing, not part of this basic setup)
...
See `vim_shortcuts.html` in this same folder for the full shortcut reference.
